                    ...
                    <div style="    background-color: linear-gradient(to right, #2980b9, #2c3e50);;" class="panel-heading">
                        <div class="row">
                            <div class="col col-sm-3 col-xs-12">
                                <h4 class="title">Route <span>List</span></h4>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>idRout </th>
                                    <th>ville_departID</th>
                                    <th>ville_arriveeID</th>
                                    <th>duree</th>
                                    <th>distance</th>
                                    <th>état</th>
                                </tr>
                            ...
                            <?php foreach ($routesDATA as $route)  : ?>
                                <tr>
                                    <td><?= $route->getIdRoute(); ?></td>
                                    <td><?=  $route->getVille_departID();?></td>
                                    <td><?= $route->getVille_arriveeID();?></td>
                                    <td><?=  $route->getDuree();?></td>
